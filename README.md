...
* **TCP, Escáneres y Proxies (Cap. 2)**: Creación de escáneres de puertos TCP concurrentes optimizados con *Worker Pools* y `sync.WaitGroup`, desarrollo de servidores Echo, proxies TCP para redirección de puertos y réplica de la funcionalidad de ejecución remota de comandos de Netcat.
  ##### Escáneres (https://github.com/Mario-Malgioglio/Blackhatgo/blob/main/1/escaner-de-puertos-concurrente.md)
  ##### Servidor-echo (https://github.com/Mario-Malgioglio/Blackhatgo/blob/main/1/servidor-echo-concurrente.md)
  ##### Implementacion-proxy-tcp(https://github.com/Mario-Malgioglio/Blackhatgo/blob/main/1/implementacion-proxy-tcp.md)
